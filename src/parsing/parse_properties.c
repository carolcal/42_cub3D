...
/*   Updated: 2025/06/25 17:23:23 by cayamash         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void    parse_textures(t_map *map, char *line)
{
    ...
    if (ft_strncmp(line, "NO", 2) == 0)
		set_texture(&map->texture[NORTH], line);
    else if (ft_strncmp(line, "SO", 2) == 0)
		set_texture(&map->texture[SOUTH], line);
    else if (ft_strncmp(line, "WE", 2) == 0)
		set_texture(&map->texture[WEST], line);
    else
		set_texture(&map->texture[EAST], line);
}
